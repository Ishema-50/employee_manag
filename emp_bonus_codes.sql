...
VALUES (100, 'niyo', 'bosco', 'bosco@example.com', '123-456-7890', TO_DATE('2020-01-15', 'YYYY-MM-DD'), 'Manager', 80000, 10);

INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_TITLE, SALARY, DEPARTMENT_ID)
VALUES (101, 'manzi', 'Bernard', 'bern@example.com', '987-654-3210', TO_DATE('2019-05-20', 'YYYY-MM-DD'), 'Developer', 60000, 30);

INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_TITLE, SALARY, DEPARTMENT_ID)
VALUES (102, 'Alice', 'mwiza', 'alice@example.com', '555-123-4567', TO_DATE('2021-03-10', 'YYYY-MM-DD'), 'Sales Rep', 55000, 40);

INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_TITLE, SALARY, DEPARTMENT_ID)
VALUES (103, 'Bob', 'prince', 'prince@example.com', '444-987-6543', TO_DATE('2018-11-05', 'YYYY-MM-DD'), 'Marketer', 50000, 20);

INSERT INTO EMPLOYEES (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_TITLE, SALARY, DEPARTMENT_ID)
VALUES (104, 'ishimwe', 'Davis', 'davis@example.com', '333-456-7890', TO_DATE('2022-07-01', 'YYYY-MM-DD'), 'Analyst', 65000, 30);
